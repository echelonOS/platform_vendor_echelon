...
ALARM_PATH := vendor/echelon/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/echelon/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/echelon/prebuilt/common/media/audio/ringtones
